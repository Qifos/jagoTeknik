                ...
                <div class="calendar h-100" id="calendar" data-year="2025" data-month="5">
                    <div class="cal-top mb-3">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-light ms-2" id="calToday"
                        ...
                        <div class="course-card p-4 h-100 d-flex flex-column">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="badge badge-cat">{{ Carbon::parse($kelas->tanggal)->format('d M Y') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-auto pt-3 border-top border-secondary">
                                <small class="text-muted">
                                    <i
                                        class="bi bi-clock me-2"></i>{{ Carbon::parse($kelas->jam_mulai)->format('H:i') }}
                                    - {{ Carbon::parse($kelas->jam_selesai)->format('H:i') }}
                                </small>
                            </div>
                        </div>
                    </a>
