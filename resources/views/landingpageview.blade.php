# Create a Bootstrap 5 landing page based on the provided prototype.
# We'll save two files: index.html and styles.css
  ...
  <footer class="py-4 border-top border-opacity-10">
    <div class="container d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-center">
      <div class="small text-secondary">
        © 2025 JagoTeknik. All rights reserved.
      </div>
...
css = r"""/* Custom styles to approximate the prototype */
:root{
  --purple-500:#6c63ff;
  --bg-950:#0c0c12;
  --bg-900:#0f0f17;
...
html,body{font-family:"Poppins",system-ui,-apple-system,"Segoe UI",Roboto,"Helvetica Neue","Noto Sans","Liberation Sans",Arial,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";}

body{
  background: radial-gradient(1200px 800px at 70% -10%, rgba(108,99,255,.12), transparent 60%),
...
Path("/mnt/data/styles.css").write_text(css, encoding="utf-8")
"/mnt/data/index.html and styles.css created"
