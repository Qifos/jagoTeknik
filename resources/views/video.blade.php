                ...
                <div class="col-lg-4">
                    <div class="video-sidebar">
                        <div class="position-relative mb-3">
                            <img src="https://placehold.co/600x340/000/fff?text={{ urlencode($video->nama_video ?? 'Video') }}"
                                class="img-fluid rounded" alt="{{ $video->nama_video }}">
                        ...
                        <h2 class="h3 text-white fw-bold d-flex justify-content-between align-items-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M5.172 10.172a.5.5 0 0 0 .707 0l4-4a.5.5 0 0 0 0-.707l-4-4a.5.5 0 0 0-.707.707L8.793 9.5H5.5a.5.5 0 0 0 0 1h3.293l-3.62 3.62a.5.5 0 0 0 0 .707z" />
                                <path fill-rule="evenodd"
                                    d="M10.828 5.828a.5.5 0 0 0-.707 0l-4 4a.5.5 0 0 0 0 .707l4 4a.5.5 0 0 0 .707-.707L7.207 6.5H10.5a.5.5 0 0 0 0-1H7.207l3.62-3.62a.5.5 0 0 0 0-.707z" />
                            </svg>
                        </h2>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://placehold.co/40x40/888/white?text={{ urlencode(substr($matkul->mentor->nama ?? 'Mentor', 0, 2)) }}"
                                class="rounded-circle" alt="{{ $matkul->mentor->nama ?? 'Mentor' }}">
                            <div class="ms-3">
                            ...
                            <div class="related-videos">
                                @foreach ($relatedVideos as $relatedVideo)
                                    @if ($relatedVideo->id_video !== $video->id_video)
                                        <a href="{{ route('media.video.detail', ['id' => $relatedVideo->id_video]) }}"
                                            class="related-video-item d-flex mb-2 text-decoration-none">
                                            <img src="https://placehold.co/60x40/000/fff?text=V" class="rounded me-2"
                                                alt="{{ $relatedVideo->nama_video }}">
                                            <div class="text-start flex-grow-1">
                                                <p class="mb-1 small text-white fw-bold">
                                                    {{ substr($relatedVideo->nama_video, 0, 20) }}...</p>
                                                <small
                                                    class="text-white-50">{{ $relatedVideo->durasi ?? 'Video' }}</small>
                                            </div>
                                        </a>
                                    @endif
                                @endforeach
                ...
                <div class="col-lg-8">
                    <div class="video-player">
                        <div class="ratio ratio-16x9">
                            <video controls
                                poster="https://placehold.co/1280x720/000/333?text=Video+Player+{{ $videoId ?? 1 }}"
                                class="w-100" id="mainVideo">
