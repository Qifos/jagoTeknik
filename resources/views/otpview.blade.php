...
<body>
  <div class="login-container">
    ...
    <main class="login-right">
      <div class="auth-panel">
        ...
        @isset($email)
          <div class="otp-hint small mb-4">Kami mengirimkan kode ke <strong>{{ $email }}</strong>. Cek inbox/spam ya.</div>
        @endisset
  ...
  <script>
    // OTP UX: auto move, paste 4 digit, set hidden input
    (function(){
