...
<head>
  ...
  <style>
    ...
    .hero-name{ font-weight:800; font-size:1.6rem; margin:0; }
    .hero-role{ margin:4px 0 0; opacity:.9; }
    .hero-btn{
      background:#e6dbf4;
      color:#5b3a6b;
      border:0;
    ...
    .section-title{ font-size:1.7rem; font-weight:800; margin: 26px 0 18px; }
    ...
    .stat-label{ opacity:.9; margin-top:6px; }
...
<body>
  ...
  <div class="wrap">
    <div class="container">
      ...
      <div class="hero">
        <div class="hero-left">
          <img class="avatar" src="{{ $mentor->foto_profil ?: 'https://i.pravatar.cc/300?img=11' }}" alt="{{ $mentor->nama }}">
          <div>
