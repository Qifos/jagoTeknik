            ...
            <div class="panel">
                ...
                <form action="{{ route('username.set') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control ipt" id="username" name="username"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control ipt" id="tanggal_lahir" name="tanggal_lahir"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" class="form-control ipt" id="no_hp" name="no_hp" inputmode="numeric"
