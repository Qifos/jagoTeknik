                ...
                <div class="container-fluid px-4">
                            ...
                            <div class="collapse navbar-collapse" id="navMenu">
                                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
                                    <li class="nav-item"><a class="nav-link active"
                                            href="{{ route('login.view') }}">Beranda</a></li>
                                    <li class="nav-item d-none d-lg-block">
                                        <form class="d-flex" role="search" onsubmit="return false;">
                                            <div class="input-group">
                                                ...
                                                <span
                                                    class="input-group-text bg-transparent border-end-0 text-secondary"><i
                    ...
                    <header class="landing-hero pt-9">
                        <header class="landing-hero pt-9 container-fluid px-4">
                            <header class="landing-hero pt-9 container-fluid px-4">
                                        ...
                                        <div class="col-lg-6 mt-5 mt-lg-0">
                                            ...
                                            <div class="d-grid d-sm-inline-flex gap-3 align-items-center mb-5">
                                                <a href="{{ route('register.view') }}"
                                                    class="btn btn-gradient fw-semibold w-100">
                                                    Daftar Sekarang
                                                </a>
                                            </div>

                                            <div class="d-flex flex-wrap gap-3">
                                                <div class="feature-pill"><i class="bi bi-award"></i><span>Tutor
                                                        Berkualitas</span></div>
                                                <div class="feature-pill"><i class="bi bi-layers"></i><span>Materi
                                                        Terbaru</span></div>
                                                <div class="feature-pill"><i class="bi bi-lightbulb"></i><span>Soal
                                                        HOTS</span></div>
                                            </div>
                                        </div>
                                ...
                                <section id="apa-jagoteknik" class="py-5">
                                    <div class="container text-center">
                                        <h1 class="fw-bold mb-3" style="letter-spacing:.2px; color:var(--brand-5);">
                                        ...
                                        <p class="mx-auto desc-text" style="max-width:900px">
                                            ...
                                            dengan lebih dari 300 member serta 300+ sesi belajar selama periode semester
                                            2023/2024.
                                        ...
                                        <div class="row g-2">
                                            <div class="col-12 col-lg-6">
                                                <div class="image-card border rounded-4 shadow-sm">
                                                    <img src="{{ asset('image/landing-apa1.jpg') }}"
                                                        alt="Masuk sebagai Mentor"
                                                        class="img-fluid w-100 d-block rounded-4" loading="lazy"
                                                        style="height:auto;" />
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="image-card border rounded-4">
                                                    <img src="{{ asset('image/landing-apa2.jpg') }}"
                                    ...
                                    <div class="container feature-cards">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="feature-card">
                                                    <div class="feature-head">
                                                        <img src="image/lpcard1.png" alt="icon"
                                                            clas="feature-icon">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="feature-card">
                                                    <div class="feature-head">
                                                        <img src="image/lpcard2.png" alt="icon"
                                                            clas="feature-icon">
                                                        <h3 class="feature-title">Materi terupdate kurikulum terbaru
                                                        </h3>
                                                    </div>
                                                    <p class="feature-desc">
                                                        Pelajari materi dari kurikulum terbaru, tidak perlu tertinggal
                                                        lagi
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="feature-card">
                                                    ...
                                                    <p class="feature-desc">
                                                        Monitor perkembanganmu, pilih jadwal yang cocok, hingga ambil
                                                        mata kuliah yang kamu
                                                        butuhkan
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 position-relative">
                                            <a href="{{ route('login.view') }}" class="d-block">
                                                <img src="image/lpkelas1.png" alt="Kelas 1"
                                                    class="img-fluid feature-class"
                                                    style="border-radius: 12px; transition: transform 0.3s ease;">
                                            </a>
                                        </div>
                                        <div class="col-12 col-md-4 position-relative">
                                            <a href="{{ route('login.view') }}" class="d-block">
                                                <img src="image/lpkelas2.png" alt="Kelas 2"
                                                    class="img-fluid feature-class"
                                                    style="border-radius: 12px; transition: transform 0.3s ease;">
                                            </a>
                                        </div>
                                        <div class="col-12 col-md-4 position-relative">
                                            <a href="{{ route('login.view') }}" class="d-block">
                                                <img src="image/lpkelas3.png" alt="Kelas 3"
                                                    class="img-fluid feature-class"
                                                    style="border-radius: 12px; transition: transform 0.3s ease;">
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="row g-4">
                                                <div class="col-12">
                                                    <div class="news-card">
                                                        <div class="news-card-content">
                                                            <img src="image/jnews1.png" alt="News 1"
                                                                class="news-card-img-vertical" />
                                                            <div class="news-content">
                                                                <p class="news-date">November 16, 2024</p>
                                                                <h3 class="news-title">EAS Makin Dekat, Sudah Siap?
                                                                </h3>
                                                                <p class="news-desc">Halo sobat Jago Teknik, tak terasa
                                                                    EAS sudah semakin
                                                ...
                                                <div class="col-12">
                                                    <div class="news-card">
                                                        <div class="news-card-content">
                                                            <img src="image/jnews2.png" alt="News 2"
                                                                class="news-card-img-vertical" />
                                                            <div class="news-content">
                                                                <p class="news-date">September 24, 2024</p>
                                                                <h3 class="news-title">Cara Menghafal Rumus Cepat</h3>
                                                                <p class="news-desc">Menghafal rumus pastinya sangat
                                                                    susah bagi kebanyakan
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="news-card">
                                                <div class="news-card-content-vertical">
                                                    <img src="image/jnews3.png" alt="News 3"
                                                        class="news-card-img" />
                                                    <div class="news-content">
                                                        <p class="news-date mt-4">March 13, 2024</p>
                                                        <h3 class="news-title">Jago Teknik Gratis?</h3>
                                                        <p class="news-desc">Ada info terbaru nih, dengar dengar jago
                                                            teknik sekarang bakal
                            ...
                            <!-- FOOTER -->
                            <footer class="py-5 border-top border-opacity-25"
                                style="border-color:var(--border)!important;">
                                <div class="container text-left text-white">
                                    <div class="row align-items-left">
                                        <div class="col-md-2 text-md-left">
                                            <div class="footer-logo">
                                                <img src="image/jagoteknik.png" alt="Jago Teknik Logo"
                                    ...
                                    <div class="container mt-4">
                                        <div class="row d-flex align-items-center justify-content-between">
                                            <div class="col-12 col-md-6 text-md-left">
                                                <p class="mb-0" style="text-align: left">© <span
                                                        id="year"></span> Jago Teknik. All
                                                    rights reserved.</p>
                                            </div>
