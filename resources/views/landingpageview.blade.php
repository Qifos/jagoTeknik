  ...
  <div class="row g-4">
    ...
    <div class="col-12 col-md-4">
      <div class="feature-card">
        ...
        <p class="feature-desc">
          Monitor perkembanganmu, pilih jadwal yang cocok, hingga ambil mata kuliah yang kamu butuhkan
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4 position-relative">
            <a href="{{ route('login.view') }}" class="d-block">
                <img src="image/lpkelas1.png" alt="Kelas 1" class="img-fluid feature-class" style="border-radius: 12px; transition: transform 0.3s ease;">
            </a>
        </div>
        <div class="col-12 col-md-4 position-relative">
            <a href="{{ route('login.view') }}" class="d-block">
                <img src="image/lpkelas2.png" alt="Kelas 2" class="img-fluid feature-class" style="border-radius: 12px; transition: transform 0.3s ease;">
            </a>
        </div>
        <div class="col-12 col-md-4 position-relative">
            <a href="{{ route('login.view') }}" class="d-block">
                <img src="image/lpkelas3.png" alt="Kelas 3" class="img-fluid feature-class" style="border-radius: 12px; transition: transform 0.3s ease;">
            </a>
        </div>
    </div>
    <!-- "Lihat Lebih Banyak Kelas" Button -->
        <div class="text-center mt-4">
            <a href="{{ route('login.view') }}" class="btn btn-outline-light px-5 py-2" style="position: relative;">
