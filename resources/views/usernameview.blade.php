...
<body>
    <div class="login-container">
        ...
        <main class="login-right">
            <div class="panel">
                ...
                <!-- Form untuk mengisi username dan data profil lainnya -->
                <form action="{{ route('username.set') }}" method="POST">
    @csrf
    <!-- Username -->
    <div class="mb-3">
        <div class="label">Username</div>
        <input type="text" class="form-control ipt" id="username" name="username" value="{{ old('username') }}" required>
        @error('username')
    ...
    <div class="mb-3">
        ...
        <input type="text" inputmode="numeric" maxlength="4" class="form-control ipt" id="angkatan" name="angkatan" placeholder="Masukkan tahun angkatan anda" required>
    </div>

    <!-- Tanggal lahir -->
    <div class="mb-3">
        <div class="label">Tanggal lahir</div>
        <input type="date" class="form-control ipt" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan tanggal lahir anda" required>
    </div>

    <!-- Jurusan -->
    <div class="mb-3">
        <div class="label">Jurusan</div>
        <select class="form-select ipt" name="id_jurusan" required>
    ...
    <div class="mb-4">
        ...
        <input type="tel" class="form-control ipt" id="no_hp" name="no_hp" inputmode="numeric" placeholder="Masukkan nomor HP anda" required>
    </div>
