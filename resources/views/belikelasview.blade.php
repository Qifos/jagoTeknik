    ...
    <main class="flex-grow-1">
        <div class="container-fluid px-lg-5 py-4">
            <div class="beli-header">
                <a href="#"
                    onclick="if(history.length > 1) { history.back(); return false; } else { window.location = '{{ route('kelas.semua') }}'; }"
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-7">
                    ...
                    <nav class="class-tabs mb-3">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-rating-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-rating" type="button" role="tab" aria-controls="nav-rating"
                                aria-selected="false">Rating</button>
                            <button class="nav-link" id="nav-benefit-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-benefit" type="button" role="tab"
                                aria-controls="nav-benefit" aria-selected="false">Benefit</button>
                        </div>
                    </nav>
                    ...
                    <div class="tab-content py-3" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="nav-overview" role="tabpanel"
                            ...
                            <p>{{ $kelas->deskripsi ?? ($kelas->deskripsi_kelas ?? 'Deskripsi kelas tidak tersedia.') }}
                            </p>
                        </div>
                        ...
                        <!-- Benefit Tab -->
                        <div class="tab-pane fade" id="nav-benefit" role="tabpanel"
                            aria-labelledby="nav-benefit-tab">
                ...
                <div class="col-lg-5">
                    <div class="beli-sidebar">
                        <img src="{{ $kelas->image_path ? asset($kelas->image_path) : asset('images/kelas/default.jpg') }}"
                            alt="{{ $kelas->nama_matkul }}" class="sidebar-image"
                            onerror="this.src='{{ asset('images/kelas/default.jpg') }}'">
                        ...
                        <a href="{{ route('pembayaran.checkout', ['id' => $kelas->id_matkul]) }}"
                            class="btn btn-beli">
            ...
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <i class="bi bi-mortarboard-fill me-2"
                            style="font-size: 1.5rem; color: var(--primary-purple);"></i>
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="mailto:jagoteknikcourse@gmail.com"
                                class="footer-link">jagoteknikcourse@gmail.com</a></li>
